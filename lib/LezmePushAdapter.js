...
exports.LezmePushAdapter = undefined;
...
var LezmePushAdapter = exports.LezmePushAdapter = function () {
    ...
    try {
      for (var _iterator = pushTypes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        switch (pushType) {
          ...
          case 'android':
          case 'fcm':
            this.senderMap[pushType] = new _MGCM2.default.MGCM(pushConfig[pushType]);
            break;
        }
      }
    } catch (err) {
