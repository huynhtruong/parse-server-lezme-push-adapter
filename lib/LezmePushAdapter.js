...
var LezmeParsePushAdapter = function () {
  function LezmeParsePushAdapter() {
    var pushConfig = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, LezmeParsePushAdapter);
    ...
    try {
      for (var _iterator = pushTypes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        switch (pushType) {
          ...
          case 'tvos':
          case 'osx':
            this.senderMap[pushType] = new _parseServerPushAdapter.APNS(pushConfig[pushType]);
            break;
          case 'android':
          case 'fcm':
  ...
  _createClass(LezmeParsePushAdapter, [{
  ...
  return LezmeParsePushAdapter;
}();

exports.default = LezmeParsePushAdapter;